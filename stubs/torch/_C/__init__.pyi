...
def unify_type_list(types: List[Type]) -> Type: ...
...
def _jit_assert_is_instance(obj: Any, type: Type): ...
...
def _resolve_type_from_object(obj: Any, range: SourceRange, rcb: ResolutionCallback) -> Type: ...
def _create_module_with_type(ty: Type) -> ScriptModule: ...
...
class Graph:
    ...
    def create(self, kind: str, output_num: int = 1) -> Node: ...
...
class Value:
    ...
    def setDebugName(self, n: str) -> None: ...
    def toIValue(self) -> IValue: ...
    def inferTypeFrom(self, t: Tensor) -> None: ...
    def replaceAllUsesWith(self, other: Value) -> None: ...
    def copyMetadata(self, v: Value) -> None: ...
...
class Node:
    ...
    def kind(self) -> str: ...
    def kindOf(self, attr: str) -> str: ...
    def s(self, attr: str) -> str: ...
    def s_(self, attr: str, v: str) -> None: ...
    def t(self, attr: str) -> Tensor: ...
    def t_(self, attr: str, t: Tensor) -> None: ...
    def copyAttributes(self, other: Node) -> None: ...
    ...
    def addInput(self, v: Value) -> None: ...
    ...
...
class ConcreteModuleTypeBuilder:
    ...
    def add_attribute(self, name: str, ty: Type, is_param: _bool, is_buffer: _bool): ...
    ...
    def add_function_attribute(self, name: str, ty: Type, func: Callable[..., Any]): ...
...
class ConcreteModuleType:
    ...
    @staticmethod
    def from_jit_type(ty: Type) -> ConcreteModuleType: ...
...
# Diff(twata): Renamed JitType to Type, added methods too
class Type:
    annotation_str : str
    def isSubtypeOf(self, other: Type) -> _bool: ...
    def with_dtype(self, dtype: _dtype) -> Type: ...
    def with_sizes(self, sizes: List[Optional[_int]]) -> Type: ...

class InferredType:
    def __init__(self, arg: Union[Type, str]): ...
    def type(self) -> Type: ...
...
class TupleType(Type):
    def __init__(self, a: List[Optional[Type]]) -> None: ...
    def elements(self) -> List[Type]: ...

class UnionType(Type):
    def __init__(self, a: List[Type]) -> None: ...
...
class OptionalType(Type, Generic[R]):
    def __init__(self, a: Type) -> None: ...
    def getElementType(self) -> Type: ...
